...
You have a documentation for Submission process in [/eu-tis/killchains/SUBMISSION_PROCESS.md](https://github.com/TroutSoftware/eu-tis/blob/main/killchains/SUBMISSION_PROCESS.md) if not clear, do a request in issue.
